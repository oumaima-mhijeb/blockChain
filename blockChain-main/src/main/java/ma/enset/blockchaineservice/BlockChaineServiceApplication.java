...
private BlockchainService blockchainService;
    ...
    public void run(String... args) throws Exception {
        ...
        pendingTransactions.add(new Transaction(UUID.randomUUID().toString(),new Date(),"oumaima","ccc",1000));
        pendingTransactions.add(new Transaction(UUID.randomUUID().toString(),new Date(),"oumaima","cc",2000));
        pendingTransactions.add(new Transaction(UUID.randomUUID().toString(),new Date(),"oumaima","cccc",5000));
